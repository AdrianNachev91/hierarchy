...
import com.hierarchy.service.TeamService;
...
class TeamControllerTest {
    ...
    void createTeam_MANAGER_NOT_FOUND() throws Exception {
        ...
        when(teamService.createTeam(teamRequest)).thenThrow(HierarchyHttpException.notFound("Manager not found"));
    ...
    void updateTeam_TEAM_NOT_FOUND() throws Exception {
        ...
        // Prepare
        TeamRequest teamRequest = teamRequest("Team name", "managedBy-id", "leadId", "teamType-id");
        when(teamService.updateTeam("team-id", teamRequest)).thenThrow(HierarchyHttpException.notFound("Team not found"));
    ...
    void deleteTeam_HttpException() throws Exception {
        ...
        // Prepare
        doThrow(HierarchyHttpException.notFound("Team not found")).when(teamService).deleteTeam("team-1");
