...
class EmployeeControllerTest {
    ...
    void getEmployee_HttpException() throws Exception {
        ...
        // Prepare
        when(employeeRepository.findById("1")).thenThrow(HierarchyHttpException.notFound("Employee not found"));
    ...
    void updateEmployee_ManagerDoesNotExist() throws Exception {
        ...
        Employee employee = employee("First Last", "1", "1");
        employee.setId("employee-id");
        when(employeeService.updateEmployee("employee-id", new ModelMapper().map(employee, EmployeeRequest.class))).thenThrow(HierarchyHttpException.notFound("Employee does not exist"));
    ...
    void deleteEmployee_HttpException() throws Exception {
        ...
        // Prepare
        doThrow(HierarchyHttpException.notFound("Employee not found")).when(employeeService).deleteEmployee("1");
