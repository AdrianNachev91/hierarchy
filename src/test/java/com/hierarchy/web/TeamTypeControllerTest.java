...
class TeamTypeControllerTest {
    ...
    void updateTeamType_TEAM_TYPE_NOT_FOUND() throws Exception {
        ...
        when(teamTypeService.updateTeamType("teamType-id", teamTypeRequest)).thenThrow(HierarchyHttpException.notFound("Team type not found"));
    ...
    void deleteTeamType_HttpException() throws Exception {
        ...
        // Prepare
        doThrow(HierarchyHttpException.notFound("Team type not found")).when(teamTypeService).deleteTeamType("teamType-id");
