...
import static com.hierarchy.TestUtils.json;
...
public class RoleControllerTest {
    ...
    void getRole_NotFound() throws Exception {
        Role role = Role.builder().id("1").title("role").build();
        when(roleRepository.findById("1")).thenThrow(HierarchyHttpException.notFound("Role not found"));
    ...
    void updateRole_NotFound() throws Exception {
        ...
        when(roleService.updateRole("id", roleRequest("updated-role"))).thenThrow(HierarchyHttpException.notFound("Role not found"));
    ...
    void deleteRole_NotFound() throws Exception {
        ...
        doThrow(HierarchyHttpException.notFound("No Role found to delete")).when(roleService).deleteRole("id");
